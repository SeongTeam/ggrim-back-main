...
export const AWS_CLOUD_FRONT_URL = "AWS_CLOUD_FRONT_URL";
...
export const FRONT_ROUTE_UPDATE_PASSWORD = "FRONT_ROUTE_UPDATE_PASSWORD";
export const FRONT_ROUTE_RECOVER_ACCOUNT = "FRONT_ROUTE_RECOVER_ACCOUNT";
export const ENABLE_MAIL_SERVICE_LOG = "ENABLE_MAIL_SERVICE_LOG";

// related to rate limit
export const RATE_LIMIT_ENABLED = "RATE_LIMIT_ENABLED";
export const RATE_LIMIT_DEFAULT_COUNT = "RATE_LIMIT_DEFAULT_COUNT";
export const RATE_LIMIT_DEFAULT_TTL_MS = "RATE_LIMIT_DEFAULT_TTL_MS";
export const RATE_LIMIT_METADATA = "RATE_LIMIT_METADATA";

export const FRONT_ROUTE_USER_EMAIL_VERIFICATION = "FRONT_ROUTE_USER_EMAIL_VERIFICATION";

export const PW_HASH = "PW_HASH";

// related to obfuscate
export const ENV_OBFUSCATE = "ENV_OBFUSCATE";
export const ENV_OBFUSCATE_ALPHABET = "ENV_OBFUSCATE_ALPHABET";
export const ENV_OBFUSCATE_MIN_LENGTH = "ENV_OBFUSCATE_MIN_LENGTH";
