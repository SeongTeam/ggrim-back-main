...
export type EmailVerificationTokenResponse = components['schemas']['EmailVerificationTokenResponse'];
...
export enum ApiPaths {
    ...
    AuthController_sendPinCode = "/auth/send-pin-code",
    AuthController_verifyPinCode = "/auth/verify-pin-code",
    AuthController_createSecurityToken = "/auth/security-token",
    AuthController_emailSecurityToken = "/auth/security-token/email",
    AuthController_createSecurityTokenByEmailVerification = "/auth/security-token/email-verification",
    AuthController_getOneTimeToken = "/auth/one-time-token/{id}",
    UserController_getOne = "/user/{id}",
    UserController_deleteUser = "/user/{id}",
    getManyBaseUserControllerUser = "/user",
    createOneBaseUserControllerUser = "/user",
    UserController_replacePassword = "/user/{id}/password",
    UserController_replaceUsername = "/user/{id}/username",
    UserController_replaceRole = "/user/{id}/role",
    UserController_recoverUser = "/user/recover/{id}",
